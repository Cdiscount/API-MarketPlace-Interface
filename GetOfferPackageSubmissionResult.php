<!-- Page GetOfferPackageSubmissionResult -->
...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript" src="js/GetOfferPackageSubmissionResult_FormValidationError.js"></script>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-horizontal" id="request" action="GetOfferPackageSubmissionResult_Response.php" method="POST">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="afficher_token_gopsr" class="form-control" placeholder="Enter token">
            </div>
            <div class="col-xs-7 messageContainer"></div>
          </div>
          ...
          <div class="form-group">
            <label class="control-label col-sm-3" for="packageid">PackageId</label>
            <div class="col-sm-10">
              <input type="text" name="packageid" id="packageid" class="form-control" placeholder="Enter PackageId">
            </div>
            <div class="col-xs-7 messageContainer"></div>
          </div>
